    ...
    <section className="relative">
      ...
      >
        <div className="w-full flex flex-col items-center text-center">
          ...
          <p
            className="mt-3 sm:mt-5 max-w-3xl leading-snug whitespace-normal md:whitespace-nowrap"
            style={{
              color: "var(--ink)",
          ...
          <p
            className="mt-1 max-w-3xl leading-snug whitespace-normal md:whitespace-nowrap"
            style={{
